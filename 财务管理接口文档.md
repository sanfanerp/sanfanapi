...
***
### 目录
1. 获取公司所有财务单据列表（废弃，请采用‘查询公司财务单据列表’接口）
2. 新增财务单据
3. 查询记账方式
4. 新增记账方式
5. 获取我的审批列表
...
19. 公司总账搜索(分组数据)
***
### 1. 获取公司所有财务单据列表（将废弃，请采用‘查询公司财务单据列表’接口）
#### 描述
获取公司所有财务单据列表（将废弃，请采用‘查询公司财务单据列表’接口）
#### 请求
...
"pageNum":1, //页数，从1开始
"pageSize":20, //页大小
"startDate":"201--04-01", //开始日期 格式：yyyy-MM-dd
"endDate":"201--04-30", //结束日期 格式：yyyy-MM-dd
