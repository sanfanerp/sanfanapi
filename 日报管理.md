...
startTime (integer, optional): 日报提交时间 单位小时 整时 ,
endTime (integer, optional): 日报提交截止时间 单位小时 整时 ,
weeklyStatus (boolean, optional): 是否启用周报 ,
weeklyStartTime (integer, optional): 周报提交时间 单位小时 整时 ,
weeklyEndTime (integer, optional): 周报提交截止时间 单位小时 整时 ,
weeklyStartDate (integer, optional): 周报提交时间 单位周 1-7 ,
weeklyEndDate (integer, optional): 周报提交截止时间 单位周 1-7 ,
monthlyStatus (boolean, optional): 是否启用月报 ,
monthlyStartTime (integer, optional): 月报提交时间 单位小时 整时 ,
monthlyEndTime (integer, optional): 月报提交截止时间 单位小时 整时 ,
...
remindTimeOfDay (integer, optional): 日报提醒时间 小时 ,
